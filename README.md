...
1. clone the project.
2. download the mysql db (in root folder) i have provided. or you can use migration.
3. setup the env with my sql.
4. to run project use xaamp or laragon. cause i setup this project for live server. will not php artisan serve.
